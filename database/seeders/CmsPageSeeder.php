...
class CmsPageSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pages = [
            'about-us' => ['About Us', "<p class=\"lead\">{$app} is a trusted matrimony platform dedicated to helping individuals and families find compatible life partners.</p><p>We started with a simple belief: finding a life partner should feel as warm and personal as asking a trusted family elder — but with the reach and convenience of today. Every profile on our platform is reviewed by a real person before it goes live, so the people you meet are genuine and serious about marriage.</p><p>Whether you are searching for yourself or on behalf of a son, daughter, brother or sister, we give you the tools to search by religion, community, star, education, profession and location — and the privacy controls to connect only when you are ready.</p>"],
